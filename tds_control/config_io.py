...
CONFIG_GROUPS = [
    (
        ...
        [
            ...
            ("max_voltage", "Internal absolute software voltage ceiling for the power supply."),
    ...
    (
        ...
        [
            ...
            ("low_voltage_step_threshold", "PSU voltage at or below which the finer low-voltage slew limits apply."),
            ("low_voltage_max_step_up", "Largest upward PSU action at or below the low-voltage threshold."),
            ("low_voltage_max_step_down", "Largest downward PSU action at or below the low-voltage threshold."),
    ...
    (
        ...
        [
            ...
            ("low_signal_recovery_voltage_step", "Upward PSU step used by low-signal invalid-reading recovery."),
            ...
            ("measurement_jump_probe_threshold_c", "Temperature jump size that requires a directed micro-voltage probe."),
            ("measurement_jump_probe_voltage_step", "Small PSU change used to test whether a large resistance/temperature jump persists."),
