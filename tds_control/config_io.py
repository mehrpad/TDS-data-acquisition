...
CONFIG_GROUPS = [
    ...
    (
        ...
        [
            ...
            ("startup_stable_samples", "Stable startup readings required before control begins."),
            ...
            ("startup_search_voltage_step", "Cautious voltage increment used to find a measurable startup signal."),
            ("startup_search_max_delta", "Maximum startup search increase above Initial Voltage."),
            ("startup_settle_time_s", "Settling delay after each startup search voltage."),
            ("startup_temperature_margin_c", "Maximum startup temperature above max(T0, start_T) before stopping."),
