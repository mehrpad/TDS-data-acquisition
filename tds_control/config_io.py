...
CONFIG_GROUPS = [
    (
        ...
        [
            ...
            ("DMM_speed", "Measurement speed setting sent to both DMMs. Explicit fixed DC ranges are used; auto-ranging is disabled."),
            ("dmm_synchronized_reading", "Start both DMM conversions before fetching voltage and current."),
            ("dmm_voltage_range_v", "Explicit fixed voltage-DMM range in volts; use the smallest range that covers the sample signal."),
            ("dmm_current_range_a", "Explicit fixed current-DMM range in amps; use the smallest range that covers the sample signal."),
    ...
    (
        ...
        [
            ...
            ("curve_smoothing_enabled", "Allow robust smoothing of dense, noisy curves before extrapolation."),
