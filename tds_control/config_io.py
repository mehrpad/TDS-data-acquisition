...
CONFIG_GROUPS = [
    ...
    (
        ...
        [
            ...
            ("low_current_step_threshold", "PSU voltage at or below which the finer low-voltage slew limits apply."),
            ("low_current_max_step_up", "Largest upward PSU action at or below the low-voltage threshold."),
            ("low_current_max_step_down", "Largest downward PSU action at or below the low-voltage threshold."),
    ...
    (
        ...
        [
            ...
            ("measurement_temperature_jump_guard_enabled", "When false, trust each resistance-derived temperature directly and rely only on the current slew limit; skips all jump/low-signal confirmation below."),
