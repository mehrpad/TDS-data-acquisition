...
Ni max_current = **0.31 A**, max_power_w = **0.83 W**.
These are the maximum absolute measured I and recorded P across all run 107
rows, rounded upward to two decimal places as requested. The exact measured
maxima remain in JSON provenance. These limits are not verified wire ratings. The 95% measured-current guard is retained
and now acts near 0.2945 A, above the new 0.225035 A upper table bias.
